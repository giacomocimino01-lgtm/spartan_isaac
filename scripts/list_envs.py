...
All the environments are registered in the `m_dVrk` extension. They start
...
import m_dVrk.tasks  # noqa: F401


def main():
    """Print all environments registered in `m_dVrk` extension."""
